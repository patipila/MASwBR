...
dane <- read_excel("C:\\Users\\Julia\\Downloads\\dane_do analizy (2).xlsx")
...
H0:F1=⋯=FkH0:F1=⋯=Fk (wszystkie próby pochodzą z jednej populacji) 

H1:∃i,j∈{1,…,k} Fi≠FjH1:∃i,j∈{1,…,k} Fi≠Fj (nie wszystkie próby pochodzą z tych samych populacji). 
...
H0:F1=F2H0:F1=F2 (próby pochodzą z jednej populacji) 

H1:F1≠F2H1:F1≠F2 (próby pochodzą z różnych populacji)
